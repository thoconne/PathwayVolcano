...
if (!requireNamespace("ReactomeContentService4R", quietly = TRUE)) {
  stop("The 'ReactomeContentService4R' package is required for this functionality. Please install it from GitHub: https://github.com/reactome/ReactomeContentService4R")
}
...
server <- function(input, output) {
  ...
  uploaded_data <- reactive({
    ...
    # Ensure the GeneSymbol column is formatted using str_to_title
